...
(define us-coins (list 50 25 5 1 10))
...
#| No, the order of the list does not affect the answer. Regardless of
the order, we are going to recurse through every sublist. |#
